...
import com.klef.jfsd.springboot.service.ChapterService;
...
public class AdminController 
{
	...
	public String addNewChapter(Model m)
	{
		m.addAttribute("Chapter", new Chapter());
		return "addNewCustomer";
	}
	
	@PostMapping("/addnewchapter")
	@CrossOrigin(origins = "http://localhost:4200")
	public com.klef.jfsd.springboot.model.Chapter addNewChapters(@RequestBody Chapter chapter) throws Exception
	{
